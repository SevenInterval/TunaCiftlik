...
namespace TunaCiftlik.MvcWebUI.Controllers
{
    public class CartController : Controller
    {
        ...
        public ActionResult AddToCart(int Id, int count)
        {
            ...
            if(product != null)
            {
                GetCart().AddProduct(product, count);
            }
        ...
        private Object SaveOrder(Cart cart, ShippingDetails entity)
        {
            var order = new Order();

            order.OrderNumber = "H" + (new Random()).Next(111111, 999999).ToString();
            ...
            foreach (var pr in cart.CartLines)
            {
                ...
                orderline.ProductName = pr.Product.Name;
